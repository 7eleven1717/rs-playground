            ...
            pub mod calculate {
                ...
                macro_rules! __export_docs_calculator_calculate_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        _export_eval_expression_cabi::<$ty > (arg0, arg1) } } };
                    };
                }
                #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:docs:calculator@0.1.0:adder:encoded world"
)]
#[doc(hidden)]
...
\x1fdocs:calculator/calculate@0.1.0\x05\x01\x04\0\x1bdocs:calculator/adder@0.1.0\
\x04\0\x0b\x0b\x01\0\x05adder\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
